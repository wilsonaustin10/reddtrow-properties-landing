export const foreclosureContent = {
  slug: 'foreclosure',
  ...
  testimonials: [
    {
      name: 'Michael R.',
      location: 'Dallas, TX',
      text: 'I was 3 months behind on my mortgage and the bank had started foreclosure proceedings. These guys closed in 8 days and I walked away with money in my pocket. They literally saved my credit.',
      situation: 'Avoided Foreclosure',
    },
    {
      name: 'Sandra T.',
      location: 'Fort Worth, TX',
      text: 'After my divorce, I couldn\'t afford the house on my own and fell behind. I was scared and didn\'t know what to do. They made the whole process easy and treated me with respect.',
      situation: 'Foreclosure & Divorce',
    },
    {
      name: 'James W.',
      location: 'San Antonio, TX',
      text: 'Lost my job and couldn\'t keep up with payments. I thought I was going to lose everything. They gave me a fair offer and closed before the auction date. Forever grateful.',
      situation: 'Pre-Foreclosure Sale',
    },
  ],
};
