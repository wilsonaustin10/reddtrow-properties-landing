export const relocationContent = {
  slug: 'relocation',
  ...
  testimonials: [
    {
      name: 'David & Sarah',
      location: 'Previously Dallas, TX',
      text: 'My job transferred me to Seattle with 3 weeks notice. These guys had us closed in 10 days. We didn\'t have to worry about paying two mortgages or flying back for showings.',
      situation: 'Job Relocation',
    },
    {
      name: 'Amanda L.',
      location: 'Previously Houston, TX',
      text: 'I accepted a dream job across the country but couldn\'t sell my house fast enough through a realtor. They gave me a fair offer and I was able to start my new life stress-free.',
      situation: 'Career Move',
    },
    {
      name: 'Chris R.',
      location: 'Previously Austin, TX',
      text: 'Military orders came through and I had to move fast. They understood the urgency and made it happen. Super professional and hassle-free.',
      situation: 'Military Relocation',
    },
  ],
};
