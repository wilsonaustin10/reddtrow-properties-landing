export const needToSellContent = {
  slug: 'need-to-sell',
  ...
  testimonials: [
    {
      ...
      text: 'I needed to sell quickly due to medical bills piling up. They gave me a fair offer and I had cash in my account within 2 weeks. Such a relief.',
      situation: 'Medical Emergency',
    },
    {
      name: 'Tom & Linda',
      location: 'Irving, TX',
      text: 'We inherited a house and had no idea what to do with it. They made the whole process simple and we didn\'t have to do any repairs or cleaning.',
      situation: 'Inherited Property',
    },
    {
      name: 'Marcus J.',
      location: 'Garland, TX',
      text: 'Tired landlord here. Dealing with bad tenants for years. They bought my rental property and I finally got to walk away from the headaches.',
