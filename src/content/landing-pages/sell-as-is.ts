  ...
  testimonials: [
    {
      name: 'Kevin & Mary',
      location: 'Plano, TX',
      text: 'We tried listing with a realtor but every offer came with a list of repair demands. These guys made an offer and stuck to it. No negotiations, no headaches.',
      situation: 'Failed Traditional Sale',
    },
    {
      name: 'Susan P.',
      location: 'Frisco, TX',
      text: 'My house was outdated and I didn\'t have the money or energy to fix it up. They bought it exactly as it was and I didn\'t have to lift a finger.',
      situation: 'Outdated Property',
    },
    {
      name: 'Tony G.',
      location: 'McKinney, TX',
      text: 'I left behind a garage full of stuff, old furniture, everything. They didn\'t care. Best decision I made. So much easier than dealing with all that junk.',
      situation: 'Left Everything Behind',
    },
  ],
